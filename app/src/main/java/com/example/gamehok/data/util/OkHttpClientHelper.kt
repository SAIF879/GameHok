package com.example.gamehok.data.util


import android.util.Log
import com.chuckerteam.chucker.api.ChuckerCollector
import com.chuckerteam.chucker.api.ChuckerInterceptor
import com.example.gamehok.GameHokApplication
...
class OkHttpClientHelper {
    ...
    fun getOkHttpClient(): OkHttpClient {
        val httpCacheDirectory = File(GameHokApplication.instance?.cacheDir, "http-cache")
    ...
    private fun getChuckerInterceptor(): ChuckerInterceptor? {
        ...
        val context = GameHokApplication.instance
        return context?.let {
